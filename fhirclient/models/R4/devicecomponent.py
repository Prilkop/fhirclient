...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/DeviceComponent) on 2022-04-28.
...
class DeviceComponent(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("measurementPrinciple", "measurementPrinciple", MeasmntPrinciple.str, False, None, False),
...
import sys
try:
    from . import MeasmntPrinciple
except ImportError:
    MeasmntPrinciple = sys.modules[__package__ + '.MeasmntPrinciple']
try:
