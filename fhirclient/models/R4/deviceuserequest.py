...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/DeviceUseRequest) on 2022-04-28.
...
class DeviceUseRequest(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", DeviceUseRequestStatus.str, False, None, False),
            ...
            ("priority", "priority", DeviceUseRequestPriority.str, False, None, False),
        ])
        return js
...
import sys
try:
    from . import DeviceUseRequestPriority
except ImportError:
    DeviceUseRequestPriority = sys.modules[__package__ + '.DeviceUseRequestPriority']
try:
    from . import DeviceUseRequestStatus
except ImportError:
    DeviceUseRequestStatus = sys.modules[__package__ + '.DeviceUseRequestStatus']
try:
