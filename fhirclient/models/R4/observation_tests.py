...
class ObservationTests(unittest.TestCase):
    ...
    def implObservation1(self, inst):
        ...
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].extension[0].url, "http://hl7.org/fhir/StructureDefinition/ordinalValue")
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].extension[0].valueDecimal, 2)
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].extension[0].url, "http://hl7.org/fhir/StructureDefinition/ordinalValue")
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].extension[0].valueDecimal, 2)
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].extension[0].url, "http://hl7.org/fhir/StructureDefinition/ordinalValue")
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].extension[0].valueDecimal, 2)
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.component[3].valueCodeableConcept.coding[0].extension[0].url, "http://hl7.org/fhir/StructureDefinition/ordinalValue")
        self.assertEqual(inst.component[3].valueCodeableConcept.coding[0].extension[0].valueDecimal, 2)
        self.assertEqual(inst.component[3].valueCodeableConcept.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.component[4].valueCodeableConcept.coding[0].extension[0].url, "http://hl7.org/fhir/StructureDefinition/ordinalValue")
        self.assertEqual(inst.component[4].valueCodeableConcept.coding[0].extension[0].valueDecimal, 2)
        self.assertEqual(inst.component[4].valueCodeableConcept.coding[0].system, "http://loinc.org")
    ...
    def testObservation7(self):
        inst = self.instantiate_from("observation-example-alcohol-type.json")
        self.assertIsNotNone(inst, "Must have instantiated a Observation instance")
    ...
    def implObservation7(self, inst):
        ...
        self.assertEqual(inst.code.coding[0].code, "alcohol-type")
        self.assertEqual(inst.code.coding[0].display, "Type of alcohol consumed")
        self.assertEqual(inst.code.coding[0].system, "http://acme-rehab.org")
        self.assertEqual(inst.code.text, "Type of alcohol consumed")
        self.assertEqual(inst.component[0].code.coding[0].code, "alcohol-type")
        self.assertEqual(inst.component[0].code.coding[0].system, "http://acme-rehab.org")
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].code, "35748005")
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].display, "Wine (substance)")
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.component[0].valueCodeableConcept.text, "Wine")
        self.assertEqual(inst.component[1].code.coding[0].code, "alcohol-type")
        self.assertEqual(inst.component[1].code.coding[0].system, "http://acme-rehab.org")
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].code, "53410008")
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].display, "Beer (substance)")
        self.assertEqual(inst.component[1].valueCodeableConcept.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.component[1].valueCodeableConcept.text, "Beer")
        self.assertEqual(inst.component[2].code.coding[0].code, "alcohol-type")
        self.assertEqual(inst.component[2].code.coding[0].system, "http://acme-rehab.org")
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].code, "6524003")
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].display, " Distilled spirits (substance)")
        self.assertEqual(inst.component[2].valueCodeableConcept.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.component[2].valueCodeableConcept.text, "Liquor")
        ...
        self.assertEqual(inst.id, "alcohol-type")
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.status, "final")
    ...
    def implObservation10(self, inst):
        ...
        self.assertEqual(inst.component[0].dataAbsentReason.coding[0].system, "http://terminology.hl7.org/CodeSystem/data-absent-reason")
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.note[0].text, "In this example, the blood pressure measurements are not available due to cancellation of the order.  Data absent reason is present for each component")
