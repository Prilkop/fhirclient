...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ProcessRequest) on 2022-04-28.
...
class ProcessRequest(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("action", "action", ActionList.str, False, None, True),
...
try:
    ...
    ActionList = sys.modules[__package__ + '.ActionList']
try:
    from . import coding
except ImportError:
